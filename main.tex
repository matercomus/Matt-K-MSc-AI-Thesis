...
\begin{compactoutline}
  \outlineitem{Differential Privacy Integration -- DP-SGD during DiffTraj training, noise injection mechanisms}
  \outlineitem{Trajectory-Level Privacy Protection -- Instance-level privacy units, trajectory anonymization techniques}
  \outlineitem{Synthetic Data Privacy Guarantees -- Generative approach benefits, decoupling from real data}
  \outlineitem{K-Anonymity and Generalization -- Spatial and temporal generalization, origin-destination grouping}
  \outlineitem{Privacy-Preserving Anomaly Detection -- LM-TAD privacy considerations, token-level protection}
  \outlineitem{Attack Resistance Mechanisms -- Membership inference protection, reconstruction attack mitigation}
  \outlineitem{Privacy Budget Management -- Epsilon allocation across pipeline phases, privacy accounting}
  \outlineitem{Cross-City Generalization Privacy -- Transfer learning privacy implications, model sharing protocols}
  \outlineitem{Evaluation and Validation -- Privacy attack simulations, utility-privacy trade-off measurement}
  \outlineitem{Regulatory Compliance -- GDPR considerations, data minimization principles}
\end{compactoutline}
