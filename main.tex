...
\begin{compactoutline}
   ...
   \outlineitem{Method limitations -- parameter sensitivity, global threshold issues~\matt{ADD CITATION}}
   ...
   \outlineitem{Performance comparison -- traditional vs. deep learning methods~\matt{ADD CITATION}}
