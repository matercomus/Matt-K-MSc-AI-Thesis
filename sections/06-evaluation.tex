...
Trial 0 always runs vanilla training ($\lambda = 0$) to establish the baseline. The best configuration from exploration is then validated with three random seeds (42, 43, 44) to assess robustness.
