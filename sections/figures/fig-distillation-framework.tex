\begin{figure}[t]
    ...
    \begin{tikzpicture}[
        ...
        \node[data, above=1.0cm of input] (mapping) {
            \textbf{Vocab Map} $\psi$\\
        ...
        \node[data, above left=1.0cm and 1.6cm of mapping, minimum width=2.2cm] (grid) {
            Grid Sequence\\
            {\tiny $\mathbf{z}_{1:t}$}
        };
        ...
        \node[data, above right=1.0cm and 1.6cm of mapping, minimum width=2.2cm] (candidates) {
            Candidate Set\\
        ...
        % 4a. Teacher model
        \node[frozen, above=1.0cm of grid, minimum width=2.5cm] (teacher) {
        ...
        % 4b. Student model
        \node[trainable, above=1.0cm of candidates, minimum width=2.5cm] (student) {
        ...
        % 5a. Teacher output
        \node[data, above=1.0cm of teacher, minimum width=2.2cm] (teacher_out) {
            Teacher Probs\\
        ...
        % 5b. Student output
        \node[data, above=1.0cm of student, minimum width=2.2cm] (student_out) {
            Student Logits\\
        ...
        \node[data, above=1.5cm of mapping, yshift=5.8cm, minimum width=2.8cm] (temp) {
        ...
        % 7. Multi-task losses
        \node[loss, above left=1.2cm and 1.2cm of temp] (ce) {
            $\mathcal{L}_{\text{CE}}$\\
            {\tiny Cross-entropy}
        };
        \node[loss, above=1.2cm of temp] (kl) {
            $\mathcal{L}_{\text{KL}}$\\
            {\tiny KL divergence}
        };
        \node[loss, above right=1.2cm and 1.2cm of temp] (time_loss) {
        ...
        % 8. Total loss
        \node[loss, above=1.2cm of kl, minimum width=4.2cm, minimum height=0.85cm] (total) {
            \textbf{Total Loss}\\
        ...
        \begin{scope}[shift={(6, 3.5)}]
            \node[magnify, minimum width=3cm, minimum height=4.5cm] (mag_arch_box) at (0, 0) {};
            \node[above=0.03cm of mag_arch_box.north, font=\footnotesize\bfseries, text=orange!70!black] {\tiny Model Architectures};
            
            % Teacher architecture
            \node[font=\tiny\bfseries, text=blue!70] at (0, 1.8) {Teacher (Frozen)};
            \node[smallbox, fill=blue!8, draw=blue!50, font=\tiny, text width=2.4cm, minimum height=1.5cm] (teacher_arch) at (0, 0.8) {
                \textbf{LM-TAD}\\[1pt]
            ...
            % Separator
            \draw[draw=gray!30] (-1.2, -0.15) -- (1.2, -0.15);
            
            % Student architecture  
            \node[font=\tiny\bfseries, text=green!70!black] at (0, -0.6) {Student (Trainable)};
            \node[smallbox, fill=green!8, draw=green!50, font=\tiny, text width=2.4cm, minimum height=1.5cm] (student_arch) at (0, -1.6) {
                \textbf{HOSER}\\[1pt]
                {\scriptsize • Zone GCN}\\
